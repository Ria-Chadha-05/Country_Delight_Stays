...
![Mumbai market-sizing funnel](assets/Mumbai_Funnel.png)
...
![Framing the core problem, opportunity, and open question](assets/problem_analysis.png)
...
![Eight hypothesized behavioural segments](assets/behavioural_segment.png)
...
![Competitive positioning map — luxury vs. mass choice, authenticity vs. transaction](assets/competitive_positioning.png)

![Evolution of the curated nature-experience category](assets/evolution.png)
...
![Who we are, who we aren't, and what we won't become](assets/who_we_are.png)
...
![What weighs more for Mid vs. Premium customers](assets/segment.png)
...
![Proposed discovery flow — feeling first, geography last](assets/insight.png)
